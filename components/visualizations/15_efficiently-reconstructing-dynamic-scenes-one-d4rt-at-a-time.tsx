...
const data = [
  ...
  { subject: "Robustness", A: 70, fullMark: 100 },
  { subject: "Generalization", A: 71, fullMark: 100 },
  { subject: "Efficiency", A: 62, fullMark: 100 },
  { subject: "Scalability", A: 70, fullMark: 100 },
];

export default function PaperViz_15({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
