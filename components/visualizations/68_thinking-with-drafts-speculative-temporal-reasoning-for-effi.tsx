...
const data = [
  ...
  { subject: "Generalization", A: 57, fullMark: 100 },
  { subject: "Efficiency", A: 72, fullMark: 100 },
  { subject: "Scalability", A: 70, fullMark: 100 },
];

export default function PaperViz_68({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
