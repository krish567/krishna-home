...
const data = [
  { name: "Training Data", value: 72, color: "#f59e0b" },
  { name: "Validation", value: 7, color: "#ef4444" },
  { name: "Test Set", value: 5, color: "#ec4899" },
  { name: "Real-world", value: 19, color: "#8b5cf6" },
];

export default function PaperViz_48({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
