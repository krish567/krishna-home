...
const data = [
  ...
  { subject: "Speed", A: 64, fullMark: 100 },
  { subject: "Robustness", A: 75, fullMark: 100 },
  { subject: "Generalization", A: 74, fullMark: 100 },
  { subject: "Efficiency", A: 82, fullMark: 100 },
  { subject: "Scalability", A: 95, fullMark: 100 },
];

export default function PaperViz_06({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
