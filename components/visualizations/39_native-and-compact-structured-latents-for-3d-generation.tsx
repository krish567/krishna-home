...
const data = [
  ...
  { subject: "Robustness", A: 83, fullMark: 100 },
  { subject: "Generalization", A: 78, fullMark: 100 },
  { subject: "Efficiency", A: 74, fullMark: 100 },
  { subject: "Scalability", A: 93, fullMark: 100 },
];

export default function PaperViz_39({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
