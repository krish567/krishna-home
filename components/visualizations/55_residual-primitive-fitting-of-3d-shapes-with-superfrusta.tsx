...
const data = [
  ...
  { subject: "Generalization", A: 81, fullMark: 100 },
  { subject: "Efficiency", A: 64, fullMark: 100 },
  { subject: "Scalability", A: 89, fullMark: 100 },
];

export default function PaperViz_55({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
