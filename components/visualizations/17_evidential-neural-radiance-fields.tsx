...
const data = [
  { subject: "Accuracy", A: 83, fullMark: 100 },
  { subject: "Speed", A: 71, fullMark: 100 },
  { subject: "Robustness", A: 81, fullMark: 100 },
  { subject: "Generalization", A: 86, fullMark: 100 },
  { subject: "Efficiency", A: 66, fullMark: 100 },
  { subject: "Scalability", A: 90, fullMark: 100 },
];

export default function PaperViz_17({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
