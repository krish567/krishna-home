...
const data = [
  { subject: "Accuracy", A: 71, fullMark: 100 },
  { subject: "Speed", A: 67, fullMark: 100 },
  { subject: "Robustness", A: 72, fullMark: 100 },
  { subject: "Generalization", A: 84, fullMark: 100 },
  { subject: "Efficiency", A: 84, fullMark: 100 },
  { subject: "Scalability", A: 75, fullMark: 100 },
];

export default function PaperViz_25({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
