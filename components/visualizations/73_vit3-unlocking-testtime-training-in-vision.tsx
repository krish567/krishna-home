...
const data = [
  { name: "Training Data", value: 50, color: "#f59e0b" },
  { name: "Validation", value: 6, color: "#ef4444" },
  { name: "Test Set", value: 14, color: "#ec4899" },
  { name: "Real-world", value: 17, color: "#8b5cf6" },
];

export default function PaperViz_73({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
