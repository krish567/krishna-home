...
const data = [
  { name: "Method A", value: 82, color: "#8b5cf6" },
  { name: "Method B", value: 81, color: "#8b5cf6" },
  { name: "Method C", value: 80, color: "#8b5cf6" },
  { name: "Ours", value: 96, color: "#3b82f6" },
  { name: "Baseline", value: 59, color: "#8b5cf6" },
];

export default function PaperViz_36({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
