...
const data = [
  { name: "Training Data", value: 91, color: "#3b82f6" },
  { name: "Validation", value: 6, color: "#8b5cf6" },
  { name: "Test Set", value: 7, color: "#ec4899" },
  { name: "Real-world", value: 22, color: "#f59e0b" },
];

export default function PaperViz_16({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
