...
const data = [
  { name: "Training Data", value: 61, color: "#3b82f6" },
  { name: "Validation", value: 14, color: "#8b5cf6" },
  { name: "Test Set", value: 9, color: "#ec4899" },
  { name: "Real-world", value: 14, color: "#f59e0b" },
];

export default function PaperViz_11({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
