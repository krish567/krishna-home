...
const data = [
  ...
  { subject: "Robustness", A: 89, fullMark: 100 },
  { subject: "Generalization", A: 75, fullMark: 100 },
  { subject: "Efficiency", A: 79, fullMark: 100 },
  { subject: "Scalability", A: 72, fullMark: 100 },
];

export default function PaperViz_63({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
