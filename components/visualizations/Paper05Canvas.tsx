...
export default function Paper05Canvas() {
    ...
    <div className="bg-slate-950 min-h-screen text-white overflow-x-hidden">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800/50">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between h-14">
          <span className="font-bold text-sm truncate" style={{ color: "#6366f1" }}>ChordEdit: One-Step Low-Energy Transport</span>
 ...
 ChordEdit: One-Step Low-Energy Transport for Image Editing
          ...
          <div className="mt-6 max-w-3xl mx-auto rounded-2xl p-5 text-left border"
            ...
            <p className="text-slate-300 text-sm leading-relaxed">ChordEdit: One-Step Low-Energy Transport for Image Editing</p>
          </div>

          <div className="mt-6 text-slate-500 text-xs max-w-2xl mx-auto">
            Liangsi Lu ⋅ Xuhang Chen ⋅ Minzhe Guo ⋅ Shichu Li ⋅ Jingchao Wang ⋅ Ya...
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          <Reveal delay={100}>
            <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6">
              <p className="text-slate-300 leading-relaxed">ChordEdit: One-Step Low-Energy Transport for Image Editing</p>
            </div>
          </Reveal>
<Reveal delay={200}>
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/40">
                ...
                <div className="text-slate-400 text-xs mt-1">ChordEdit: One-Step Low-Energy Transport for Image Editing</div>
              </div>
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/40">
                <span className="text-2xl">📉</span>
...
<div className="flex items-center gap-3 mb-8">
      ...
      <footer className="border-t border-slate-800 py-8 text-center text-slate-600 text-sm">
        <p>ChordEdit: One-Step Low-Energy Transport for Image Editing • CVPR 2026</p>
      </footer>
    </div>
  );
}