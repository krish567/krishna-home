    ...
    <div className="bg-slate-950 min-h-screen text-white overflow-x-hidden">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800/50">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between h-14">
          <span className="font-bold text-sm truncate" style={{ color: "#10b981" }}>Linear Fundamental Matrix Estimation from 7...</span>
      ...
      <section id="overview" className="flex flex-col justify-center items-center px-4 py-16 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <div className="mt-6 max-w-3xl mx-auto rounded-2xl p-5 text-left border"
            ...
            <p className="text-slate-300 text-sm leading-relaxed">We revisit the problem of estimating the fundamental matrix of a pair of perspective cameras, a cornerstone of geometric computer vision.As is well-known, linear solvers require at least 8 point correspondences, whereas nonlinear minimal solvers require just 7 in the uncalibrated case or 5 in the calibrated case.In this paper, we consider a special</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10">
            <StatCard value="8" label="Score" sublabel="Primary metric" color="#10b981" delay={0} />
            <StatCard value="7" label="Metric" sublabel="Relative score" color="#3b82f6" delay={100} />
            <StatCard value="5" label="Value" sublabel="Performance" color="#f97316" delay={200} />
            <StatCard value="7" label="Index" sublabel="Key metric" color="#a78bfa" delay={300} />
          </div>
              ...
              <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  <div className="border-l-2 border-orange-500/40 pl-4">
                    ...
                    <div className="text-orange-400/80 text-xs mt-1">Current methods fall short in addressing Linear Fundamental Matrix Estimation from 7 or 5 P effectively</div>
                  </div>
                  <div className="border-l-2 border-orange-500/40 pl-4">
      ...
      <footer className="border-t border-slate-800 py-8 text-center text-slate-600 text-sm">
        <p>Linear Fundamental Matrix Estimation from 7 or 5... • CVPR 2026 • Taci Ata Kucukpinar et al.</p>
      </footer>
    </div>
  );
}
