...
export default function Paper26Canvas() {
    ...
    <div className="bg-slate-950 min-h-screen text-white overflow-x-hidden">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800/50">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between h-14">
          <span className="font-bold text-sm truncate" style={{ color: "#3b82f6" }}>ImmerIris: A Large-Scale Dataset and Ben</span>
      ...
      <section id="overview" className="flex flex-col justify-center items-center px-4 py-16 relative overflow-hidden">
        ...
        <div className="absolute top-20 left-1/4 w-72 h-72 rounded-full blur-3xl opacity-20" style={{ backgroundColor: "#3b82f6" }} />
        <div className="absolute bottom-20 right-1/4 w-96 h-96 rounded-full blur-3xl opacity-15" style={{ backgroundColor: "#8b5cf6" }} />
 ...
 ImmerIris: A Large-Scale Dataset and Benchmark for Off-Axis and Unconstrained Iris Recognition in Immersive Applications
          ...
          <div className="mt-6 max-w-3xl mx-auto rounded-2xl p-5 text-left border"
            ...
            <p className="text-slate-300 text-sm leading-relaxed">ImmerIris: A Large-Scale Dataset and Benchmark for Off-Axis and Unconstrained Iris Recognition in Immersive Applications</p>
          </div>

          <div className="mt-6 text-slate-500 text-xs max-w-2xl mx-auto">
            Yuxi Mi ⋅ Qiuyang Yuan ⋅ Zhizhou Zhong ⋅ Xuan Zhao ⋅ Jiaogen Zhou ⋅ Fu...
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          <Reveal delay={100}>
            <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6">
              <p className="text-slate-300 leading-relaxed">ImmerIris: A Large-Scale Dataset and Benchmark for Off-Axis and Unconstrained Iris Recognition in Immersive Applications</p>
            </div>
          </Reveal>
<Reveal delay={200}>
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/40">
                ...
                <div className="text-slate-400 text-xs mt-1">ImmerIris: A Large-Scale Dataset and Benchmark for Off-Axis </div>
              </div>
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/40">
                <span className="text-2xl">📉</span>
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-6">
              <div className="bg-slate-800/50 rounded-xl p-5 border" style={{ borderColor: "#3b82f630" }}>
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-2xl">💡</span>
                  <span className="font-bold" style={{ color: "#3b82f6" }}>Innovation</span>
                </div>
              ...
              <div className="bg-slate-800/50 rounded-xl p-5 border" style={{ borderColor: "#8b5cf630" }}>
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-2xl">📈</span>
                  <span className="font-bold" style={{ color: "#8b5cf6" }}>Scalability</span>
                </div>
              ...
              <div className="bg-slate-800/50 rounded-xl p-5 border" style={{ borderColor: "#ec489930" }}>
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-2xl">🌐</span>
                  <span className="font-bold" style={{ color: "#ec4899" }}>Generalization</span>
                </div>
              ...
              <div className="bg-slate-800/50 rounded-xl p-5 border" style={{ borderColor: "#10b98130" }}>
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-2xl">✅</span>
                  <span className="font-bold" style={{ color: "#10b981" }}>Evaluation</span>
                </div>
...
<div className="flex items-center gap-3 mb-8">
          ...
          <Reveal delay={100}>
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="bg-slate-900/60 border rounded-2xl p-5" style={{ borderColor: "#8b5cf630" }}>
          ...
          <Reveal delay={200}>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-5 text-center">
                <div className="text-3xl font-black" style={{ color: "#3b82f6" }}>3-5</div>
              ...
              <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-5 text-center">
                <div className="text-3xl font-black" style={{ color: "#ec4899" }}>+17%</div>
      ...
      <footer className="border-t border-slate-800 py-8 text-center text-slate-600 text-sm">
        <p>ImmerIris: A Large-Scale Dataset and Benchmark for Off-Axis  • CVPR 2026</p>
      </footer>
    </div>
  );
}