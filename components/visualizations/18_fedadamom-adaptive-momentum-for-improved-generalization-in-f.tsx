...
const data = [
  { name: "Training Data", value: 70, color: "#f59e0b" },
  { name: "Validation", value: 5, color: "#ef4444" },
  { name: "Test Set", value: 6, color: "#ec4899" },
  { name: "Real-world", value: 21, color: "#8b5cf6" },
];

export default function PaperViz_18({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
