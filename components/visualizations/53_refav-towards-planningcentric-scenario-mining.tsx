...
const data = [
  ...
  { subject: "Efficiency", A: 81, fullMark: 100 },
  { subject: "Scalability", A: 77, fullMark: 100 },
];

export default function PaperViz_53({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
