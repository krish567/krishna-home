...
const data = [
  ...
  { subject: "Speed", A: 83, fullMark: 100 },
  { subject: "Robustness", A: 84, fullMark: 100 },
  { subject: "Generalization", A: 70, fullMark: 100 },
  { subject: "Efficiency", A: 52, fullMark: 100 },
  { subject: "Scalability", A: 74, fullMark: 100 },
];

export default function PaperViz_46({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
