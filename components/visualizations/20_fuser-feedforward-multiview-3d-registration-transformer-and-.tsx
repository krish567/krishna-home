...
const data = [
  ...
  { subject: "Robustness", A: 74, fullMark: 100 },
  { subject: "Generalization", A: 66, fullMark: 100 },
  { subject: "Efficiency", A: 62, fullMark: 100 },
  { subject: "Scalability", A: 85, fullMark: 100 },
];

export default function PaperViz_20({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
