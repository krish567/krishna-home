...
const data = [
  ...
  { subject: "Robustness", A: 71, fullMark: 100 },
  { subject: "Generalization", A: 56, fullMark: 100 },
  { subject: "Efficiency", A: 53, fullMark: 100 },
  { subject: "Scalability", A: 75, fullMark: 100 },
];

export default function PaperViz_21({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
