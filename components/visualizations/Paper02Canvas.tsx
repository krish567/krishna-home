...
export default function Paper02Canvas() {
    ...
    <div className="bg-slate-950 min-h-screen text-white overflow-x-hidden">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800/50">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between h-14">
          <span className="font-bold text-sm truncate" style={{ color: "#f59e0b" }}>Adversarial Style Optimization: Enhancing...</span>
      ...
      <section id="overview" className="flex flex-col justify-center items-center px-4 py-16 relative overflow-hidden">
        ...
        <div className="absolute top-20 left-1/4 w-72 h-72 rounded-full blur-3xl opacity-20 animate-pulse" style={{ backgroundColor: "#f59e0b" }} />
        <div className="absolute bottom-20 right-1/4 w-96 h-96 rounded-full blur-3xl opacity-15 animate-pulse" style={{ backgroundColor: "#ef4444", animationDelay: "1s" }} />
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <div className="mt-6 max-w-3xl mx-auto rounded-2xl p-5 text-left border"
            ...
            <p className="text-slate-300 text-sm leading-relaxed">Multimodal Large Language Models (MLLMs) have achieved impressive performance, but their safety alignment remains vulnerable to jailbreak attacks. Existing content-based jailbreaks are often inconsistent and show low attack success rates (ASR) against commercial closed-source MLLMs, failing to exploit non-content-based vulnerabilities. Unlike previ</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10">
            <StatCard value="---" label="Metric" sublabel="Primary metric" color="#f59e0b" delay={0} />
            <StatCard value="---" label="Score" sublabel="Relative score" color="#ef4444" delay={100} />
            <StatCard value="---" label="Value" sublabel="Performance" color="#06b6d4" delay={200} />
            <StatCard value="---" label="Index" sublabel="Key metric" color="#8b5cf6" delay={300} />
          </div>
              ...
              <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  <div className="border-l-2 border-orange-500/40 pl-4">
                    ...
                    <div className="text-orange-400/80 text-xs mt-1">Current methods fall short in addressing Adversarial Style Optimization: Enhancing VLM Jail effectively</div>
                  </div>
                  <div className="border-l-2 border-orange-500/40 pl-4">
          ...
          <Reveal delay={200}>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-5 text-center">
                <div className="text-3xl font-black" style={{ color: "#f59e0b" }}>+21%</div>
      ...
      <footer className="border-t border-slate-800 py-8 text-center text-slate-600 text-sm">
        <p>Adversarial Style Optimization: Enhancing VLM... • CVPR 2026 • Bingjun Luo et al.</p>
      </footer>
    </div>
  );
}
