...
const data = [
  { subject: "Accuracy", A: 93, fullMark: 100 },
  { subject: "Speed", A: 67, fullMark: 100 },
  { subject: "Robustness", A: 65, fullMark: 100 },
  { subject: "Generalization", A: 83, fullMark: 100 },
  { subject: "Efficiency", A: 82, fullMark: 100 },
  { subject: "Scalability", A: 91, fullMark: 100 },
];

export default function PaperViz_50({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
