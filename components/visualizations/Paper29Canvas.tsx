...
export default function Paper29Canvas() {
    ...
    <div className="bg-slate-950 min-h-screen text-white overflow-x-hidden">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800/50">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between h-14">
          <span className="font-bold text-sm truncate" style={{ color: "#3b82f6" }}>Learning Eigenstructures of Unstructured...</span>
      ...
      <section id="overview" className="flex flex-col justify-center items-center px-4 py-16 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <div className="mt-6 max-w-3xl mx-auto rounded-2xl p-5 text-left border"
            ...
            <p className="text-slate-300 text-sm leading-relaxed">We introduce a novel framework that directly learns a spectral basis for shape and manifold analysis from unstructured data, eliminating the need for traditional operator selection, discretization, and eigensolvers.Grounded in optimal-approximation theory, we train a network to decompose an implicit approximation operator by minimizing the reconstr</p>
          </div>
              ...
              <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  <div className="border-l-2 border-orange-500/40 pl-4">
                    ...
                    <div className="text-orange-400/80 text-xs mt-1">Current methods fall short in addressing Learning Eigenstructures of Unstructured Data Mani effectively</div>
                  </div>
                  <div className="border-l-2 border-orange-500/40 pl-4">
      ...
      <footer className="border-t border-slate-800 py-8 text-center text-slate-600 text-sm">
        <p>Learning Eigenstructures of Unstructured Data... • CVPR 2026 • Roy Velich et al.</p>
      </footer>
    </div>
  );
}
