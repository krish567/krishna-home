...
const data = [
  { subject: "Accuracy", A: 82, fullMark: 100 },
  { subject: "Speed", A: 61, fullMark: 100 },
  { subject: "Robustness", A: 79, fullMark: 100 },
  { subject: "Generalization", A: 62, fullMark: 100 },
  { subject: "Efficiency", A: 50, fullMark: 100 },
  { subject: "Scalability", A: 73, fullMark: 100 },
];

export default function PaperViz_38({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
