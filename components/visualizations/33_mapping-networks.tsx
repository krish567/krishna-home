...
const data = [
  { name: "Training Data", value: 77, color: "#f59e0b" },
  { name: "Validation", value: 16, color: "#ef4444" },
  { name: "Test Set", value: 10, color: "#ec4899" },
  { name: "Real-world", value: 27, color: "#8b5cf6" },
];

export default function PaperViz_33({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
