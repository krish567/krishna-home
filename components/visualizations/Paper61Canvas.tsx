...
export default function Paper61Canvas() {
    ...
    <div className="bg-slate-950 min-h-screen text-white overflow-x-hidden">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800/50">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between h-14">
          <span className="font-bold text-sm truncate" style={{ color: "#6366f1" }}>SeeGroup: Multi-Layer Depth Estimation of...</span>
      ...
      <section id="overview" className="flex flex-col justify-center items-center px-4 py-16 relative overflow-hidden">
        ...
        <div className="absolute top-20 left-1/4 w-72 h-72 rounded-full blur-3xl opacity-20 animate-pulse" style={{ backgroundColor: "#6366f1" }} />
        <div className="absolute bottom-20 right-1/4 w-96 h-96 rounded-full blur-3xl opacity-15 animate-pulse" style={{ backgroundColor: "#ec4899", animationDelay: "1s" }} />
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <div className="mt-6 max-w-3xl mx-auto rounded-2xl p-5 text-left border"
            ...
            <p className="text-slate-300 text-sm leading-relaxed">Transparent objects are common in daily life, and understanding their multi-layer depth information, including both the transparent surface and the objects behind it, is crucial for real-world applications that interact with transparent materials.However, existing depth methods produce only a single depth map, which is inherently ambiguous for tran</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10">
            <StatCard value="---" label="Metric" sublabel="Primary metric" color="#6366f1" delay={0} />
            <StatCard value="---" label="Score" sublabel="Relative score" color="#ec4899" delay={100} />
            <StatCard value="---" label="Value" sublabel="Performance" color="#14b8a6" delay={200} />
            <StatCard value="---" label="Index" sublabel="Key metric" color="#f97316" delay={300} />
          </div>
              ...
              <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  <div className="border-l-2 border-orange-500/40 pl-4">
                    ...
                    <div className="text-orange-400/80 text-xs mt-1">Current methods fall short in addressing SeeGroup: Multi-Layer Depth Estimation of Transpar effectively</div>
                  </div>
                  <div className="border-l-2 border-orange-500/40 pl-4">
          ...
          <Reveal delay={200}>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-5 text-center">
                <div className="text-3xl font-black" style={{ color: "#6366f1" }}>+21%</div>
              ...
              <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-5 text-center">
                <div className="text-3xl font-black" style={{ color: "#14b8a6" }}>Ablation</div>
      ...
      <section id="findings" className="flex items-center px-4 py-16">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <Reveal delay={200}>
              <div className="bg-slate-900/60 border rounded-2xl p-6" style={{ borderColor: "#6366f130" }}>
                <div className="text-2xl mb-3">📈</div>
            ...
            <Reveal delay={400}>
              <div className="bg-slate-900/60 border rounded-2xl p-6" style={{ borderColor: "#14b8a630" }}>
                <div className="text-2xl mb-3">🌐</div>
      ...
      <footer className="border-t border-slate-800 py-8 text-center text-slate-600 text-sm">
        <p>SeeGroup: Multi-Layer Depth Estimation of... • CVPR 2026 • Hongyu Wen et al.</p>
      </footer>
    </div>
  );
}
