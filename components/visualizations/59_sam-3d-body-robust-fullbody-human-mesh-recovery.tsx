...
const data = [
  ...
  { subject: "Robustness", A: 85, fullMark: 100 },
  { subject: "Generalization", A: 77, fullMark: 100 },
  { subject: "Efficiency", A: 81, fullMark: 100 },
  { subject: "Scalability", A: 88, fullMark: 100 },
];

export default function PaperViz_59({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
