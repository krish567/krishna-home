...
const data = [
  { subject: "Accuracy", A: 84, fullMark: 100 },
  { subject: "Speed", A: 89, fullMark: 100 },
  { subject: "Robustness", A: 68, fullMark: 100 },
  { subject: "Generalization", A: 81, fullMark: 100 },
  { subject: "Efficiency", A: 73, fullMark: 100 },
  { subject: "Scalability", A: 75, fullMark: 100 },
];

export default function PaperViz_35({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
