...
export default function Paper22Canvas() {
    ...
    <div className="bg-slate-950 min-h-screen text-white overflow-x-hidden">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800/50">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between h-14">
          <span className="font-bold text-sm truncate" style={{ color: "#3b82f6" }}>GeoViS: Geospatially Rewarded Visual Search...</span>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 bg-slate-800/50 rounded-xl p-3">
                    ...
                    <div>
                      ...
                      <div className="text-slate-400 text-sm">Existing approaches have narrow applicability in vision-language models</div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3 bg-slate-800/50 rounded-xl p-3">
                    <span className="text-2xl">📉</span>
              ...
              <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  <div className="border-l-2 border-orange-500/40 pl-4">
                    <div className="text-white font-medium text-sm">Gap in Vision-Language Models</div>
                    <div className="text-orange-400/80 text-xs mt-1">Current methods fall short in addressing GeoViS: Geospatially Rewarded Visual Search for Re effectively</div>
                  </div>
                  <div className="border-l-2 border-orange-500/40 pl-4">
                  ...
                  <div className="border-l-2 border-orange-500/40 pl-4">
                    ...
                    <div className="text-orange-400/80 text-xs mt-1">Novel approaches required to push boundaries of vision-language models</div>
                  </div>
                </div>
              </div>
            </Reveal>
          ...
          <Reveal delay={300}>
            <div className="mt-8 bg-gradient-to-r from-slate-900 to-slate-800/80 border border-slate-700/40 rounded-2xl p-6 flex items-center gap-6">
              ...
              <div>
                ...
                <div className="text-slate-400 text-sm mt-1">Advancing vision-language models has significant implications for real-world applications and academic research</div>
              </div>
            </div>
          </Reveal>
        </div>
                ...
                <div className="relative bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6 overflow-hidden">
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-white font-bold text-lg">Vision Understanding</h3>
                      <div className="text-slate-400 text-sm">Visual comprehension and reasoning</div>
                    </div>
                  </div>
                  <div className="mb-4">
                    <div className="text-xs text-slate-500 mb-2">KEY CHALLENGES</div>
                    <div className="flex flex-wrap gap-2">
                      <span key="0" className="text-xs px-2 py-1 rounded-full" style={{ background: "#3b82f615", color: "#3b82f6" }}>Object recognition</span>
                      <span key="1" className="text-xs px-2 py-1 rounded-full" style={{ background: "#3b82f615", color: "#3b82f6" }}>Spatial reasoning</span>
                      <span key="2" className="text-xs px-2 py-1 rounded-full" style={{ background: "#3b82f615", color: "#3b82f6" }}>Scene understanding</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-slate-500">Metric: VQA Accuracy</span>
                ...
                <div className="relative bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6 overflow-hidden">
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-white font-bold text-lg">Language Alignment</h3>
                      <div className="text-slate-400 text-sm">Vision-language alignment quality</div>
                    </div>
                  </div>
                  <div className="mb-4">
                    <div className="text-xs text-slate-500 mb-2">KEY CHALLENGES</div>
                    <div className="flex flex-wrap gap-2">
                      <span key="0" className="text-xs px-2 py-1 rounded-full" style={{ background: "#8b5cf615", color: "#8b5cf6" }}>CLIP score</span>
                      <span key="1" className="text-xs px-2 py-1 rounded-full" style={{ background: "#8b5cf615", color: "#8b5cf6" }}>Cross-modal</span>
                      <span key="2" className="text-xs px-2 py-1 rounded-full" style={{ background: "#8b5cf615", color: "#8b5cf6" }}>Grounding</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-slate-500">Metric: Alignment Score</span>
                ...
                <div className="relative bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6 overflow-hidden">
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-white font-bold text-lg">Multimodal Reasoning</h3>
                      <div className="text-slate-400 text-sm">Joint vision-language reasoning</div>
                    </div>
                  </div>
                  <div className="mb-4">
                    <div className="text-xs text-slate-500 mb-2">KEY CHALLENGES</div>
                    <div className="flex flex-wrap gap-2">
                      <span key="0" className="text-xs px-2 py-1 rounded-full" style={{ background: "#ec489915", color: "#ec4899" }}>VQA</span>
                      <span key="1" className="text-xs px-2 py-1 rounded-full" style={{ background: "#ec489915", color: "#ec4899" }}>Image captioning</span>
                      <span key="2" className="text-xs px-2 py-1 rounded-full" style={{ background: "#ec489915", color: "#ec4899" }}>Reasoning</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-slate-500">Metric: Task Accuracy</span>
                ...
                <div className="relative bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6 overflow-hidden">
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <div className="text-slate-400 text-sm">Inference speed and memory</div>
                    </div>
                  </div>
                  <div className="mb-4">
                    <div className="text-xs text-slate-500 mb-2">KEY CHALLENGES</div>
                    <div className="flex flex-wrap gap-2">
                      ...
                      <span key="2" className="text-xs px-2 py-1 rounded-full" style={{ background: "#10b98115", color: "#10b981" }}>Throughput</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-slate-500">Metric: Tokens/sec</span>
            ...
            <div className="bg-gradient-to-r from-slate-900 to-slate-800/80 border border-slate-700/40 rounded-2xl p-6 mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-slate-400 mt-1">The proposed approach substantially outperforms existing methods, establishing new benchmarks for vision-language models</div>
                </div>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={500}>
            <div className="bg-blue-900/20 border border-blue-500/30 rounded-2xl p-6 flex items-center gap-6">
              ...
              <div>
                ...
                <div className="text-slate-400 text-sm mt-1">Code and models publicly available. Enables reproducible research and accelerates progress in vision-language models</div>
              </div>
            </div>
          </Reveal>
        </div>
      ...
      <footer className="border-t border-slate-800 py-8 text-center text-slate-600 text-sm">
        <p>GeoViS: Geospatially Rewarded Visual Search for... • CVPR 2026 • Peirong Zhang et al.</p>
      </footer>
    </div>
  );
}
