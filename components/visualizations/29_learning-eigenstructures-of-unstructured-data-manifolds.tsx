...
export default function PaperViz_29({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
    <div className="relative w-full rounded-2xl overflow-hidden p-6" style={{background: "linear-gradient(135deg, #0c1425 0%, #1a0a2e 100%)"}}>
      <div className="absolute top-4 right-4 w-16 h-16 rounded-full blur-xl" style={{background: "#3b82f6", opacity: 0.3}} />
      ...
      <div className="h-48">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data}>
            ...
            <Line type="monotone" dataKey="quality" stroke="#10b981" strokeWidth={3} dot={{r: 2}} />
            <Line type="monotone" dataKey="speed" stroke="#3b82f6" strokeWidth={2} strokeDasharray="5 5" dot={false} />
          </LineChart>
        </ResponsiveContainer>
      </div>
      <div className="mt-3 flex gap-4">
        <div className="flex items-center gap-2">
          <div className="w-6 h-1 rounded" style={{background: "#10b981"}} />
