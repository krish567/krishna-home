...
const data = [
  { name: "Training Data", value: 81, color: "#3b82f6" },
  { name: "Validation", value: 17, color: "#8b5cf6" },
  { name: "Test Set", value: 8, color: "#ec4899" },
  { name: "Real-world", value: 19, color: "#f59e0b" },
];

export default function PaperViz_56({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
