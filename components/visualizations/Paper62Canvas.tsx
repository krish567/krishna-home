...
export default function Paper62Canvas() {
    ...
    <div className="bg-slate-950 min-h-screen text-white overflow-x-hidden">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800/50">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between h-14">
          <span className="font-bold text-sm truncate" style={{ color: "#f59e0b" }}>SmokeSVD: Smoke Reconstruction from A Si</span>
 ...
 SmokeSVD: Smoke Reconstruction from A Single View via Progressive Novel View Synthesis and Refinement with Diffusion Models
          ...
          <div className="mt-6 max-w-3xl mx-auto rounded-2xl p-5 text-left border"
            ...
            <p className="text-slate-300 text-sm leading-relaxed">SmokeSVD: Smoke Reconstruction from A Single View via Progressive Novel View Synthesis and Refinement with Diffusion Models</p>
          </div>

          <div className="mt-6 text-slate-500 text-xs max-w-2xl mx-auto">
            Chen Li ⋅ Shanshan Dong ⋅ Sheng Qiu ⋅ Jianmin Han ⋅ Yibo Zhao ⋅ Zan Ga...
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          <Reveal delay={100}>
            <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6">
              <p className="text-slate-300 leading-relaxed">SmokeSVD: Smoke Reconstruction from A Single View via Progressive Novel View Synthesis and Refinement with Diffusion Models</p>
            </div>
          </Reveal>
<Reveal delay={200}>
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/40">
                ...
                <div className="text-slate-400 text-xs mt-1">SmokeSVD: Smoke Reconstruction from A Single View via Progre</div>
              </div>
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/40">
                <span className="text-2xl">📉</span>
...
<div className="flex items-center gap-3 mb-8">
      ...
      <footer className="border-t border-slate-800 py-8 text-center text-slate-600 text-sm">
        <p>SmokeSVD: Smoke Reconstruction from A Single View via Progre • CVPR 2026</p>
      </footer>
    </div>
  );
}