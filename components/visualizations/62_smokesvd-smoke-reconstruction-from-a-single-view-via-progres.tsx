...
const data = [
  { subject: "Accuracy", A: 74, fullMark: 100 },
  { subject: "Speed", A: 62, fullMark: 100 },
  { subject: "Robustness", A: 86, fullMark: 100 },
  { subject: "Generalization", A: 67, fullMark: 100 },
  { subject: "Efficiency", A: 57, fullMark: 100 },
  { subject: "Scalability", A: 70, fullMark: 100 },
];

export default function PaperViz_62({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
