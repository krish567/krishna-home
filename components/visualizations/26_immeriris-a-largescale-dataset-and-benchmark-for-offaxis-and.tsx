...
const data = [
  { name: "Training Data", value: 84, color: "#3b82f6" },
  { name: "Validation", value: 15, color: "#8b5cf6" },
  { name: "Test Set", value: 11, color: "#ec4899" },
  { name: "Real-world", value: 28, color: "#f59e0b" },
];

export default function PaperViz_26({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
