...
const data = [
  { name: "Training Data", value: 67, color: "#3b82f6" },
  { name: "Validation", value: 9, color: "#8b5cf6" },
  { name: "Test Set", value: 12, color: "#ec4899" },
  { name: "Real-world", value: 11, color: "#f59e0b" },
];

export default function PaperViz_01({ title, authors, type }: { title: string; authors: string; type: string }) {
  return (
