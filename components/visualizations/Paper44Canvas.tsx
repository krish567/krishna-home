...
export default function Paper44Canvas() {
    ...
    <div className="bg-slate-950 min-h-screen text-white overflow-x-hidden">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800/50">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between h-14">
          <span className="font-bold text-sm truncate" style={{ color: "#f59e0b" }}>OpenDance: Multimodal Controllable 3D Dance...</span>
      ...
      <section id="overview" className="flex flex-col justify-center items-center px-4 py-16 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10">
            ...
            <StatCard value="100" label="Metric" sublabel="Relative score" color="#ef4444" delay={100} />
            <StatCard value="14" label="Value" sublabel="Performance" color="#06b6d4" delay={200} />
            <StatCard value="147" label="Index" sublabel="Key metric" color="#8b5cf6" delay={300} />
          </div>
              ...
              <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  <div className="border-l-2 border-orange-500/40 pl-4">
                    ...
                    <div className="text-orange-400/80 text-xs mt-1">Current methods fall short in addressing OpenDance: Multimodal Controllable 3D Dance Genera effectively</div>
                  </div>
                  <div className="border-l-2 border-orange-500/40 pl-4">
      ...
      <footer className="border-t border-slate-800 py-8 text-center text-slate-600 text-sm">
        <p>OpenDance: Multimodal Controllable 3D Dance... • CVPR 2026 • Jinlu Zhang et al.</p>
      </footer>
    </div>
  );
}
